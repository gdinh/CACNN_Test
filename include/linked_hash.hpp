//THIS LIBRARY is from https://github.com/ez8-co/linked_hash/blob/master/linked_hash.hpp
//and is licensed under MIT https://github.com/ez8-co/linked_hash/blob/master/LICENSE
